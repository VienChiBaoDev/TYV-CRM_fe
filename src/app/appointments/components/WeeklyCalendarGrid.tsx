      ...
      <CardContent className="p-0">
        <ScrollArea className="w-full">
          {loading ? (
            ...
            >
              <div className="sticky left-0 z-20 border-b border-r border-border bg-muted" />
              ...
              {weekDays.map((day) => {
                ...
                return (
                  <div
                    key={day.toISOString()}
                    className={cn(
                      "sticky top-0 z-10 border-b border-r border-border bg-muted p-2 text-center text-xs font-semibold",
