...
export const MOCK_PATIENT_SERVICES: PatientService[] = [
  {
    ...
    serviceName: "KÊ ĐƠN",
    progress: { current: 1, total: 1, maxAllowed: 1 },
  ...
  },
  {
    ...
    progress: { current: 4, total: 10, maxAllowed: 10 },
    amount: {
  ...
  },
  {
    ...
    progress: { current: 2, total: 5, maxAllowed: 5 },
  ...
  },
  {
    ...
    progress: { current: 3, total: 3, maxAllowed: 3 },
